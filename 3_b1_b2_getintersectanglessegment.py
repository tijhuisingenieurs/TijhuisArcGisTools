...
from gistools.tools.validatie import get_local_intersect_angles
...
# input_fl1 = './testdata/input/Testdata_dwarsprofielen.shp'
# input_fl2 = './testdata/input/Testdata_watergangen.shp'
# output_file = './testdata/output/3_b1_output.shp'
