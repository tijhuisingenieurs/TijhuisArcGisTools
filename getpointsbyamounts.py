...
# 2: Vaste waarde voor afstand (default_perc)
# 3: Lijst met velden (copy_fields)
# 4: Doelbestand voor punten

input_fl = arcpy.GetParameterAsText(0)
aantal_veld = arcpy.GetParameterAsText(1)
default_aantal = arcpy.GetParameter(2)
...
# aanroepen tool
arcpy.AddMessage('Bezig met uitvoeren van get_points_on_line_amount...')

point_col = get_points_on_line_amount(collection, 
                               copy_velden, 
                               amount_field=aantal_veld,
                               default_amount=default_aantal)
