...
# import shutil
#
# input_points = os.path.join(os.path.dirname(__file__), 'test', 'data', 'real_points_example.shp')
# input_lines = os.path.join(os.path.dirname(__file__), 'test', 'data', 'real_line_example.shp')
...
# os.mkdir(test_dir)
#
# output_file = os.path.join(test_dir, 'test_snaptoline.shp')
# tolerance = 0.01
