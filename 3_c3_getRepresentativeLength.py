...
# input_lines = './testdata/input/Testdata_dwarsprofielen.shp'
# input_profiles = './testdata/input/Testdata_watergangen.shp'
# output_file = './testdata/output/3_c3_output.shp'
