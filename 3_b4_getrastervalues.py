...
# input_fl_raster = './testdata/input/Testdata_AHN3_raster.tif'
# input_fl_points = './testdata/input/Testdata_AHN3_profielpunten.shp'
# output_file = './testdata/output/3_b4_output.shp'
