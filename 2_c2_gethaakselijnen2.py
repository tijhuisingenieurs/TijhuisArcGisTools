...
# distance_field = None
# fixed_distance = 50.0
# representative_length = 75.0
# all_lines = True
# fixed_length = 15
# length_field = None
# copy_fields = ['HYDRO_CODE', 'DATUM_KM', 'VER_EIND']
# output_file = './testdata/output/2_c2_output.shp'
...
if not distance_field and not fixed_distance:
    arcpy.AddError('Voer vaste waarde voor lengte haakse lijnen in of kies veld met de lengte voor de haakse lijnen')
...
if not length_field and not fixed_length:
    arcpy.AddError('Voer vaste waarde voor lengte haakse lijnen in of kies veld met de lengte voor de haakse lijnen')
