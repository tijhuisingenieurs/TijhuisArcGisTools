...
# import shutil
#   
# input_fl_lines = os.path.join(os.path.dirname(__file__), 'test', 'data', 'Test_kwaliteit.shp')
# input_fl_points = os.path.join(os.path.dirname(__file__), 'test', 'data', 'Test_kwaliteit_punten.shp')
#
## input_fl_lines = os.path.join(os.path.dirname(__file__), 'test', 'data', 'Shape leggervakken.shp')
## input_fl_points = os.path.join(os.path.dirname(__file__), 'test', 'data', 'Intersect_profielen_leggervakken.shp')
#  
...
# os.mkdir(test_dir)
#       
# output_file = os.path.join(test_dir, 'test_punten_afstand.shp')
